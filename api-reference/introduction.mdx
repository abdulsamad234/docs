...
The legacy **`link`** property on the affiliate object is **deprecated** and may be `null`. Use **`affiliateLinks`** (and the **[Links](/api-reference/links/get)** endpoints to manage links) as the source of truth.
