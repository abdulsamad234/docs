...
{/* TODO screenshot: filter-panel — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: filter-chips — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: columns-popover — upload it in the local Documentation Agent */}
