...
{/* TODO screenshot: customers-list — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: add-customer-menu — upload it in the local Documentation Agent */}

## What you can do from here

Open a customer's actions menu on their row to work with a single referral.

{/* TODO screenshot: customer-row-actions — upload it in the local Documentation Agent */}
