...
{/* TODO screenshot: pending-review-popover — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: bulk-status-actions — upload it in the local Documentation Agent */}
