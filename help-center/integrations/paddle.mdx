...
{/* TODO screenshot: paddle-guide-card — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: paddle-connect-form — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: disconnect-paddle — upload it in the local Documentation Agent */}
