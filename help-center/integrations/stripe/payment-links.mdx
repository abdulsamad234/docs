...
{/* TODO screenshot: integrations-payment-links-card — upload it in the local Documentation Agent */}
...
<Steps>
  <Step title="Open the connect dialog">
    ...
    {/* TODO screenshot: connect-integration-stripe — upload it in the local Documentation Agent */}
  </Step>
  ...
  <Step title="Confirm the connection">
    ...
    {/* TODO screenshot: stripe-connection-badges — upload it in the local Documentation Agent */}
  </Step>
</Steps>
...
{/* TODO screenshot: payment-links-snippet-step — upload it in the local Documentation Agent */}
...
<Steps>
  ...
  <Step title="Confirm it in Referly">
    ...
    {/* TODO screenshot: referral-from-payment-link — upload it in the local Documentation Agent */}
  </Step>
</Steps>
