...
{/* TODO screenshot: integrations-stripe-session-api-card — upload it in the local Documentation Agent */}
...
<Steps>
  <Step title="Open the connect dialog">
    ...
    {/* TODO screenshot: connect-integration-picker — upload it in the local Documentation Agent */}
  </Step>
  <Step title="Choose live or test">
    ...
    {/* TODO screenshot: stripe-connect-live-or-test — upload it in the local Documentation Agent */}
  </Step>
...
<Steps>
  ...
  <Step title="Confirm it in Referly">
    ...
    {/* TODO screenshot: referral-attributed-to-affiliate — upload it in the local Documentation Agent */}
  </Step>
</Steps>
