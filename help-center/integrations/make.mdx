...
<Steps>
  ...
  <Step title="Choose the program">
    ...
    {/* TODO screenshot: choose-program — upload it in the local Documentation Agent */}
  </Step>
  <Step title="Confirm">
    ...
    {/* TODO screenshot: connect-confirm-dialog — upload it in the local Documentation Agent */}
  </Step>
...
{/* TODO screenshot: integrations-make-card — upload it in the local Documentation Agent */}
