...
{/* TODO screenshot: pickaxe-integration-card — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: pickaxe-instructions-dialog — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: pickaxe-tracking-script — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: pickaxe-connect-stripe — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: pickaxe-test-sale — upload it in the local Documentation Agent */}
