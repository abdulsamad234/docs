...
{/* TODO screenshot: wordpress-tracking-script — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: wordpress-test-referral — upload it in the local Documentation Agent */}
