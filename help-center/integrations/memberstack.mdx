...
{/* TODO screenshot: memberstack-integration-card — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: memberstack-instructions-dialog — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: tracking-script-copy — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: connect-stripe — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: test-referral-in-customers — upload it in the local Documentation Agent */}
