...
{/* TODO screenshot: webhooks-overview — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: create-endpoint-dialog — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: endpoint-details — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: webhook-logs — upload it in the local Documentation Agent */}
