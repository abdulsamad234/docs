...
{/* TODO screenshot: custom-code-page — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: custom-css-editor — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: custom-js-editor — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: save-changes-custom-code — upload it in the local Documentation Agent */}
