...
{/* TODO screenshot: when-trigger — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: max-views — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: page-rules — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: position — upload it in the local Documentation Agent */}
