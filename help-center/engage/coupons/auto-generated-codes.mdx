...
{/* TODO screenshot: code-structure-options — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: code-preview — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: limit-groups — upload it in the local Documentation Agent */}
