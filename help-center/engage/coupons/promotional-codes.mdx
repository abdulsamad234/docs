...
{/* TODO screenshot: promotion-codes-section — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: limit-code-affiliate — upload it in the local Documentation Agent */}
