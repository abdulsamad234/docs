...
{/* TODO screenshot: connect-domain — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: verify-dns-dialog — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: sending-address-fields — upload it in the local Documentation Agent */}
