...
{/* TODO screenshot: connect-integration-button — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: connect-provider — upload it in the local Documentation Agent */}
