...
{/* TODO screenshot: webhook-logs-tab — upload it in the local Documentation Agent */}
...
{/* TODO screenshot: webhook-attempt-detail — upload it in the local Documentation Agent */}
